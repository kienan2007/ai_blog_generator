...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-!9hs+b+ao%76&-krm5a%5xdz-yhg1mu97^*42nj5a945ebj_r1')

DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = ['*']  # or specify your .up.railway.app domain
